<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $status=1;
        $level="Anggota";
        $simpan_anggota=mysqli_query($kon,"INSERT INTO anggota (kode_anggota, nama_anggota, no_telp, email, alamat) VALUES ('$kode_anggota', '$nama_anggota', '$nomor_telp', '$email', '$alamat')");
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" type="alamat" name="alamat" aria-describedby="alamat" placeholder="Masukan alamat" required />
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
